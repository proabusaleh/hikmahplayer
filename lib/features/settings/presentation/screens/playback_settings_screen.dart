          ...
          ListTile(
            ...
            trailing: DropdownButton<double>(
              ...
              items: const [0.5, 0.75, 1.0, 1.25, 1.5, 2.0]
                  ...
                  .toList(),
              onChanged: (v) => setState(() { if (v != null) prefs.defaultPlaybackSpeed = v; }),
            ),
          ),
          ListTile(
            ...
            trailing: DropdownButton<String>(
              ...
              onChanged: (v) => setState(() { if (v != null) prefs.defaultVideoFit = v; }),
            ),
          ),
          ListTile(
            ...
            trailing: DropdownButton<String>(
              ...
              onChanged: (v) => setState(() { if (v != null) prefs.loopMode = v; }),
            ),
          ),
        ],
      ),
