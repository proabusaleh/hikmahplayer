  ...
  MediaItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MediaItem(
      ...
      dateModified: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}date_modified']),
...
class Playlist extends DataClass implements Insertable<Playlist> {
  ...
  @override
  int get hashCode => Object.hash(id, name, description, mediaType,
      thumbnailPath, itemCount, totalDuration, isAuto, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Playlist &&
...
class $PlaylistItemsTable extends PlaylistItems
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, playlistId, mediaId, sortOrder, addedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $PlayHistoryTable extends PlayHistory
  ...
  late final GeneratedColumn<int> playedAt = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _durationPlayedMeta =
      const VerificationMeta('durationPlayed');
  @override
  late final GeneratedColumn<int> durationPlayed = GeneratedColumn<int>(
      'duration_played', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, mediaId, playedAt, durationPlayed, completed];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
    ...
    if (data.containsKey('duration_played')) {
      context.handle(
          ...
          durationPlayed.isAcceptableOrUnknown(
              data['duration_played']!, _durationPlayedMeta));
    }
  ...
  PlayHistoryData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PlayHistoryData(
      ...
      durationPlayed: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}duration_played'])!,
...
class PlayHistoryData extends DataClass implements Insertable<PlayHistoryData> {
  ...
  PlayHistoryData copyWithCompanion(PlayHistoryCompanion data) {
    return PlayHistoryData(
      ...
      durationPlayed: data.durationPlayed.present
  ...
  Folder map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Folder(
      ...
      lastScanned: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}last_scanned']),
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])!,
    );
  }
...
class Folder extends DataClass implements Insertable<Folder> {
  ...
  @override
  int get hashCode => Object.hash(id, path, name, mediaCount, isHidden,
      isPinned, sortOrder, lastScanned, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Folder &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index idxMediaType = Index('idx_media_type',
      'CREATE INDEX idx_media_type ON media_items (media_type)');
  late final Index idxMediaFolder = Index('idx_media_folder',
      'CREATE INDEX idx_media_folder ON media_items (folder_path)');
  late final Index idxMediaFavorite = Index('idx_media_favorite',
      'CREATE INDEX idx_media_favorite ON media_items (is_favorite)');
  late final Index idxMediaLastPlayed = Index('idx_media_last_played',
  ...
  late final Index idxHistoryMedia = Index('idx_history_media',
      'CREATE INDEX idx_history_media ON play_history (media_id)');
  late final Index idxHistoryDate = Index('idx_history_date',
...
class $$MediaItemsTableTableManager extends RootTableManager<
  ...
  $$MediaItemsTableTableManager(_$AppDatabase db, $MediaItemsTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$MediaItemsTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$MediaItemsTableOrderingComposer(ComposerState(db, table)),
...
class $$MediaItemsTableFilterComposer
    extends FilterComposer<_$AppDatabase, $MediaItemsTable> {
  $$MediaItemsTableFilterComposer(super.$state);
  ...
  ColumnFilters<int> get mediaType => $state.composableBuilder(
  ...
  ColumnFilters<String> get albumArtPath => $state.composableBuilder(
      column: $state.table.albumArtPath,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<int> get bitRate => $state.composableBuilder(
      column: $state.table.bitRate,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get sampleRate => $state.composableBuilder(
      column: $state.table.sampleRate,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<int> get dateAdded => $state.composableBuilder(
      column: $state.table.dateAdded,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get dateModified => $state.composableBuilder(
      column: $state.table.dateModified,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get lastPlayed => $state.composableBuilder(
  ...
  ColumnFilters<int> get lastPosition => $state.composableBuilder(
      column: $state.table.lastPosition,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ComposableFilter playlistItemsRefs(
      ComposableFilter Function($$PlaylistItemsTableFilterComposer f) f) {
    final $$PlaylistItemsTableFilterComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $state.db.playlistItems,
        getReferencedColumn: (t) => t.mediaId,
        builder: (joinBuilder, parentComposers) =>
            $$PlaylistItemsTableFilterComposer(ComposerState($state.db,
                $state.db.playlistItems, joinBuilder, parentComposers)));
    return f(composer);
  }

  ComposableFilter playHistoryRefs(
      ComposableFilter Function($$PlayHistoryTableFilterComposer f) f) {
    final $$PlayHistoryTableFilterComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $state.db.playHistory,
        getReferencedColumn: (t) => t.mediaId,
        builder: (joinBuilder, parentComposers) =>
            $$PlayHistoryTableFilterComposer(ComposerState($state.db,
                $state.db.playHistory, joinBuilder, parentComposers)));
    return f(composer);
  }
}

class $$MediaItemsTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $MediaItemsTable> {
  $$MediaItemsTableOrderingComposer(super.$state);
  ...
  ColumnOrderings<int> get mediaType => $state.composableBuilder(
      column: $state.table.mediaType,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<String> get albumArtPath => $state.composableBuilder(
      column: $state.table.albumArtPath,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get bitRate => $state.composableBuilder(
      column: $state.table.bitRate,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get sampleRate => $state.composableBuilder(
      column: $state.table.sampleRate,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get dateAdded => $state.composableBuilder(
      column: $state.table.dateAdded,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get dateModified => $state.composableBuilder(
      column: $state.table.dateModified,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get lastPlayed => $state.composableBuilder(
      column: $state.table.lastPlayed,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get lastPosition => $state.composableBuilder(
      column: $state.table.lastPosition,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $$PlaylistsTableFilterComposer
  ...
  ColumnFilters<int> get totalDuration => $state.composableBuilder(
      column: $state.table.totalDuration,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$PlaylistsTableOrderingComposer
  ...
  ColumnOrderings<int> get totalDuration => $state.composableBuilder(
      column: $state.table.totalDuration,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $$PlaylistItemsTableTableManager extends RootTableManager<
  ...
  $$PlaylistItemsTableTableManager(_$AppDatabase db, $PlaylistItemsTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$PlaylistItemsTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$PlaylistItemsTableOrderingComposer(ComposerState(db, table)),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
...
class $$PlaylistItemsTableFilterComposer
    extends FilterComposer<_$AppDatabase, $PlaylistItemsTable> {
  $$PlaylistItemsTableFilterComposer(super.$state);
  ColumnFilters<String> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  $$MediaItemsTableFilterComposer get mediaId {
    final $$MediaItemsTableFilterComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.mediaId,
        referencedTable: $state.db.mediaItems,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder, parentComposers) =>
            $$MediaItemsTableFilterComposer(ComposerState($state.db,
                $state.db.mediaItems, joinBuilder, parentComposers)));
    return composer;
  }
}

class $$PlaylistItemsTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $PlaylistItemsTable> {
  $$PlaylistItemsTableOrderingComposer(super.$state);
  ColumnOrderings<String> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  $$MediaItemsTableOrderingComposer get mediaId {
    final $$MediaItemsTableOrderingComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.mediaId,
        referencedTable: $state.db.mediaItems,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder, parentComposers) =>
            $$MediaItemsTableOrderingComposer(ComposerState($state.db,
                $state.db.mediaItems, joinBuilder, parentComposers)));
    return composer;
  }
}
...
class $$PlayHistoryTableTableManager extends RootTableManager<
  ...
  $$PlayHistoryTableTableManager(_$AppDatabase db, $PlayHistoryTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$PlayHistoryTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$PlayHistoryTableOrderingComposer(ComposerState(db, table)),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> mediaId = const Value.absent(),
...
class $$PlayHistoryTableFilterComposer
    extends FilterComposer<_$AppDatabase, $PlayHistoryTable> {
  $$PlayHistoryTableFilterComposer(super.$state);
  ColumnFilters<String> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get playedAt => $state.composableBuilder(
      column: $state.table.playedAt,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get durationPlayed => $state.composableBuilder(
      column: $state.table.durationPlayed,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$PlayHistoryTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $PlayHistoryTable> {
  $$PlayHistoryTableOrderingComposer(super.$state);
  ColumnOrderings<String> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get playedAt => $state.composableBuilder(
      column: $state.table.playedAt,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get durationPlayed => $state.composableBuilder(
      column: $state.table.durationPlayed,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $$FoldersTableFilterComposer
  ...
  ColumnFilters<int> get mediaCount => $state.composableBuilder(
      column: $state.table.mediaCount,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<int> get lastScanned => $state.composableBuilder(
      column: $state.table.lastScanned,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$FoldersTableOrderingComposer
  ...
  ColumnOrderings<int> get mediaCount => $state.composableBuilder(
      column: $state.table.mediaCount,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get lastScanned => $state.composableBuilder(
      column: $state.table.lastScanned,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
